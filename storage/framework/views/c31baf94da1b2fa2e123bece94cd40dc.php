...
<div class="max-w-5xl mx-auto bg-white shadow p-8 rounded-lg border border-orange-200">
    ...
    <form action="<?php echo e(route('checkout.procesar')); ?>" method="POST" class="space-y-10">
        <?php echo csrf_field(); ?>
        ...
        <section class="bg-gray-50 p-6 rounded-lg border border-orange-100">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="envio_nombre" value="<?php echo e(old('envio_nombre')); ?>"
                ...
                <div>
                    ...
                    <input type="text" name="envio_apellidos" value="<?php echo e(old('envio_apellidos')); ?>"
                           class="w-full border border-gray-300 rounded-lg p-3 focus:ring-orange-600 focus:border-orange-600">
                </div>

                <div>
                    <label class="block font-medium mb-1 text-gray-700">Email</label>
                    <input type="email" name="envio_email" value="<?php echo e(old('envio_email')); ?>"
                           class="w-full border border-gray-300 rounded-lg p-3 focus:ring-orange-600 focus:border-orange-600">
                </div>

                <div>
                    <label class="block font-medium mb-1 text-gray-700">Teléfono</label>
                    <input type="text" name="envio_telefono" value="<?php echo e(old('envio_telefono')); ?>"
                           class="w-full border border-gray-300 rounded-lg p-3 focus:ring-orange-600 focus:border-orange-600">
                </div>

                <div class="md:col-span-2">
                    <label class="block font-medium mb-1 text-gray-700">Dirección</label>
                    <input type="text" name="envio_direccion" value="<?php echo e(old('envio_direccion')); ?>"
                           class="w-full border border-gray-300 rounded-lg p-3 focus:ring-orange-600 focus:border-orange-600">
                </div>

                <div>
                    <label class="block font-medium mb-1 text-gray-700">Ciudad</label>
                    <input type="text" name="envio_ciudad" value="<?php echo e(old('envio_ciudad')); ?>"
                           class="w-full border border-gray-300 rounded-lg p-3 focus:ring-orange-600 focus:border-orange-600">
                </div>

                <div>
                    <label class="block font-medium mb-1 text-gray-700">Provincia</label>
                    <input type="text" name="envio_provincia" value="<?php echo e(old('envio_provincia')); ?>"
                           class="w-full border border-gray-300 rounded-lg p-3 focus:ring-orange-600 focus:border-orange-600">
                </div>

                <div>
                    <label class="block font-medium mb-1 text-gray-700">Código postal</label>
                    <input type="text" name="envio_cp" value="<?php echo e(old('envio_cp')); ?>"
                           class="w-full border border-gray-300 rounded-lg p-3 focus:ring-orange-600 focus:border-orange-600">
                </div>
        ...
        <section class="bg-gray-50 p-6 rounded-lg border border-orange-100">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    <label class="block font-medium mb-1 text-gray-700">Nombre</label>
                    <input type="text" name="fact_nombre" value="<?php echo e(old('fact_nombre')); ?>"
                           class="w-full border border-gray-300 rounded-lg p-3 focus:ring-orange-600 focus:border-orange-600">
                </div>

                <div>
                    <label class="block font-medium mb-1 text-gray-700">Apellidos</label>
                    <input type="text" name="fact_apellidos" value="<?php echo e(old('fact_apellidos')); ?>"
                           class="w-full border border-gray-300 rounded-lg p-3 focus:ring-orange-600 focus:border-orange-600">
                </div>

                <div>
                    <label class="block font-medium mb-1 text-gray-700">Email</label>
                    <input type="email" name="fact_email" value="<?php echo e(old('fact_email')); ?>"
                           class="w-full border border-gray-300 rounded-lg p-3 focus:ring-orange-600 focus:border-orange-600">
                </div>

                <div>
                    <label class="block font-medium mb-1 text-gray-700">Teléfono</label>
                    <input type="text" name="fact_telefono" value="<?php echo e(old('fact_telefono')); ?>"
                           class="w-full border border-gray-300 rounded-lg p-3 focus:ring-orange-600 focus:border-orange-600">
                </div>

                <div class="md:col-span-2">
                    <label class="block font-medium mb-1 text-gray-700">Dirección</label>
                    <input type="text" name="fact_direccion" value="<?php echo e(old('fact_direccion')); ?>"
                           class="w-full border border-gray-300 rounded-lg p-3 focus:ring-orange-600 focus:border-orange-600">
                </div>

                <div>
                    <label class="block font-medium mb-1 text-gray-700">Ciudad</label>
                    <input type="text" name="fact_ciudad" value="<?php echo e(old('fact_ciudad')); ?>"
                           class="w-full border border-gray-300 rounded-lg p-3 focus:ring-orange-600 focus:border-orange-600">
                </div>

                <div>
                    <label class="block font-medium mb-1 text-gray-700">Provincia</label>
                    <input type="text" name="fact_provincia" value="<?php echo e(old('fact_provincia')); ?>"
                           class="w-full border border-gray-300 rounded-lg p-3 focus:ring-orange-600 focus:border-orange-600">
                </div>

                <div>
                    <label class="block font-medium mb-1 text-gray-700">Código postal</label>
                    <input type="text" name="fact_cp" value="<?php echo e(old('fact_cp')); ?>"
                           class="w-full border border-gray-300 rounded-lg p-3 focus:ring-orange-600 focus:border-orange-600">
                </div>
        ...
        <section class="bg-gray-50 p-6 rounded-lg border border-orange-100">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="tarjeta_numero" value="<?php echo e(old('tarjeta_numero')); ?>"
                           class="w-full border border-gray-300 rounded-lg p-3 focus:ring-orange-600 focus:border-orange-600"
                ...
                <div>
                    ...
                    <input type="month" name="tarjeta_fecha" value="<?php echo e(old('tarjeta_fecha')); ?>"
                           class="w-full border border-gray-300 rounded-lg p-3 focus:ring-orange-600 focus:border-orange-600">
                </div>

                <div>
                    <label class="block font-medium mb-1 text-gray-700">CVV</label>
                    <input type="text" name="tarjeta_cvv" value="<?php echo e(old('tarjeta_cvv')); ?>"
                           class="w-full border border-gray-300 rounded-lg p-3 focus:ring-orange-600 focus:border-orange-600"
                           placeholder="123">
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Jannat\Documents\proyecto\RouiasApp\resources\views/checkout.blade.php ENDPATH**/ ?>