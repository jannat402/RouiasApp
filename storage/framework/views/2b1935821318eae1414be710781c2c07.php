    ...
    <div class="flex flex-col md:flex-row gap-6">
        ...
        <div class="flex-1">
            ...
            <p class="mt-3 text-sm text-gray-600">
                Categoría: 
                <strong class="text-orange-700"><?php echo e($producto->categoria->nombre ?? 'Sin categoría'); ?></strong><br>
                Subcategoría: 
                <strong class="text-orange-700"><?php echo e($producto->subcategoria->nombre ?? 'Sin subcategoría'); ?></strong>
            </p>

            <!-- BOTÓN AÑADIR AL CARRITO -->
            <?php if($producto->stock > 0): ?>
                <form action="<?php echo e(route('carrito.agregar')); ?>" method="POST" class="mt-5">
                    <?php echo csrf_field(); ?>
    ...
    <?php $__empty_1 = true; $__currentLoopData = $producto->valoraciones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <div class="border border-orange-200 p-4 rounded-lg mb-4 bg-white shadow-sm">
            ...
            <!-- muestro el nombre del cliente y el dia en el que se hace el comentario-->
                <p class="font-semibold text-gray-800"><?php echo e($v->usuario->name); ?></p>
