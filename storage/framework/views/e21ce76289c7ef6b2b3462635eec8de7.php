...
<form action="<?php echo e(route('admin.productos.actualizar', $producto->id)); ?>" 
    ...
    <div>
        ...
        <input type="number" step="0.01" name="precio" value="<?php echo e($producto->precio); ?>" 
               class="w-full p-2 border rounded" required>
    </div>
    ...
    <div>
        ...
        <input type="number" name="stock" value="<?php echo e($producto->stock); ?>" 
               class="w-full p-2 border rounded" required>
    </div>
    ...
    <div>
        ...
        <select name="categoria_id" class="w-full p-2 border rounded" required>
            <?php $__currentLoopData = $categorias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($cat->id); ?>" <?php if($cat->id == $producto->categoria_id): echo 'selected'; endif; ?>>
    ...
    <div>
        ...
        <select name="subcategoria_id" class="w-full p-2 border rounded" required>
            <?php $__currentLoopData = $subcategorias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sub): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($sub->id); ?>" <?php if($sub->id == $producto->subcategoria_id): echo 'selected'; endif; ?>>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Jannat\Documents\proyecto\RouiasApp\resources\views/admin/productos/editar.blade.php ENDPATH**/ ?>